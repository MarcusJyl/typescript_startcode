...
var dbConnector_1 = require("../config/dbConnector");
var debug = require("debug")("setup-friend-testdata");
var bcryptjs_1 = require("bcryptjs");
function tester() {
    return __awaiter(this, void 0, void 0, function () {
        var client, db, friendsCollection, hashedPW, status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbConnector_1.DbConnector.connect()];
                case 1:
                    client = _a.sent();
                    db = client.db(process.env.DB_NAME);
                    friendsCollection = db.collection("friends");
                    return [4 /*yield*/, bcryptjs_1.hash("secret", 8)];
                case 2:
                    hashedPW = _a.sent();
                    friendsCollection.createIndex({ email: 1 }, { unique: true });
                    return [4 /*yield*/, friendsCollection.deleteMany({})];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, friendsCollection.insertMany([
